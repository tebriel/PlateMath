 ...
 * Copyright (c) 2009-2011 by PlateMath, Inc. All Rights Reserved.
...
//@interface PlateMathObject : NSObject
//@end

@interface PlateMathObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PlateMathObject class]])
		{
			for (NSString *key in [[(PlateMathObject*)o modules] allKeys])
			{
