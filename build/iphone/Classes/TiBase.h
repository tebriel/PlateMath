...
// in simulator we redefine to format for PlateMath Developer console
...
{\
	NSString * exceptionName = [@"org.platemath." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.platemath";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIPlateMathNativeItemNone = -1, 
	UIPlateMathNativeItemSpinner = -2,
	UIPlateMathNativeItemProgressBar = -3,
	
	UIPlateMathNativeItemSlider = -4,
	UIPlateMathNativeItemSwitch = -5,
	UIPlateMathNativeItemMultiButton = -6,
	UIPlateMathNativeItemSegmented = -7,
	
	UIPlateMathNativeItemTextView = -8,
	UIPlateMathNativeItemTextField = -9,
	UIPlateMathNativeItemSearchBar = -10,
	
	UIPlateMathNativeItemPicker = -11,
	UIPlateMathNativeItemDatePicker = -12,
	
	UIPlateMathNativeItemInfoLight = -13,
	UIPlateMathNativeItemInfoDark = -14,
	
	UIPlateMathNativeItemDisclosure = -15,
	
	UIPlateMathNativeItemContactAdd = -16
};
