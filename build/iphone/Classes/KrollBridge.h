...
@interface PlateMathObject : KrollCoverageObject {
#else
@interface PlateMathObject : KrollObject {
#endif
@private
...
extern NSString * PlateMath$ModuleRequireFormat;
